...
{
    //kCCEncrypt 加密
    return [self encrypt:sText encryptOrDecrypt:kCCEncrypt key:@"cubeengine"];
}

+ (NSString *)decryptWithText:(NSString *)sText
{
    //kCCDecrypt 解密
    return [self encrypt:sText encryptOrDecrypt:kCCDecrypt key:@"cubeengine"];
}

+ (NSString *)encrptWithContentOf:(NSString *)path withKey:(NSString *)key
{
    const void *dataIn;
    size_t dataInLength;
...
+ (NSString *)decrptWithContentOf:(NSString *)path withKey:(NSString *)key
{
    ...
    //解码 base64
    NSData *decryptData = [GTMBase64 decodeData:d];//转成utf-8并decode
